                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Rena<span className="underline"></span>
                        </h4>
                        <h3 className="cover-title">
                            Happy Birthday!
                        </h3>
                        <p className="cover-subtitle">
                            A perfect message just for you... 💌
                        </p>
                    </div>

                    {/* User Image remains the same */}
                    <div className="userImg">
                        <img src="https://raw.githubusercontent.com/ssf-kariparambu/Home/main/Rena.jpg" alt="Recipient's Photo" />
                    </div>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Rena</article>
                            <article style={{ marginBottom: '10px' }}>From the moment we met, you became someone truly special in my life. You’ve been there through my happiest moments and my hardest days, always making life a little brighter and more beautiful.</article>
                            <article style={{ marginBottom: '10px' }}>On your birthday, I just want you to know that no matter where life takes us, I’ll always be there for you. Through every chapter, every challenge, and every celebration, you’ll always have me by your side.</article>
                            <article style={{ marginBottom: '10px' }}>You’re not just a friend, you’re my best friend and one of the most precious people in my life.<br/>
                                May our friendship stay this beautiful and unbreakable forever. Happy Birthday.</article>
                        </div>
